<template>
  <div>
    <p v-show="notFoundShop === false">{{ msg }}</p>
    <div class="flex items-center w-full h-screen " v-show="notFoundShop === true">
      <div class="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
        <div class="max-w-md">
          <div class="text-5xl font-bold font-dark">404</div>
            <p
              class="text-2xl font-light leading-normal md:text-3xl"
            >Không tìm thấy cửa hàng</p>
          <p class="mt-8">
            Liên hệ với chúng tôi nếu cửa hàng của bạn gặp vấn đề về kích hoạt hoặc bất kỳ sự cố nào khác: 
            <a href="mailto:contact@tiemcuatui.com">contact@tiemcuatui.com</a>
          </p>
